...
- Добавлен `Services\ResponseExceptionMapper`, преобразующий ошибочные HTTP-ответы RuStore в специализированные
  исключения.
...
- Добавлен `Services\RuStoreMessageValidator`, отвечающий за локальную валидацию ru-store-push токенов и размера
  сообщения.
